package com.guilhermaosales.springwebmvc.controller;
...
public class JediController {
    ...
    public String createJedi(@Valid @ModelAttribute Jedi jedi, BindingResult result, RedirectAttributes redirectAttributes){
        ...
        redirectAttributes.addFlashAttribute("message", "Jedi "+ jedi.getName() + " cadatrado com sucesso.");
    ...
    public String deleteJedi(@PathVariable("id") final Long id, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("message", "Jedi " + jedi.get().getName() + " removido com sucesso.");
